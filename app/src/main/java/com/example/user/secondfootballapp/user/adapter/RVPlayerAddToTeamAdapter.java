            ...
            public void onResponse(Call<ServerResponse> call, Response<ServerResponse> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (response.body() == null) {
                        ...
                        com.example.user.secondfootballapp.model.Player player = new com.example.user.secondfootballapp.model.Player();
//                        player.setId("000");
                        player.setPlayerId(personId);
                        player.setInviteStatus("Pending");
                        List<com.example.user.secondfootballapp.model.Player> playerList = team.getPlayers();
...
//                        UserCommandInfo.adapterInv.notifyDataSetChanged();
                        List<com.example.user.secondfootballapp.model.Player> players = new ArrayList<>(UserCommandInfo.playersInv);
